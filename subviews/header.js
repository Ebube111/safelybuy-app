...
const header = ({ text, color, noSearch, notification, noTagLine }) => {
  ...
  const inputProps = {
    className:
      'w-60 md:w-full bg-gray-100 focus:outline-none pl-12 pr-3 py-1 text-sm rounded-full',
    type: 'search',
            ...
            <Logo
              ...
              text={
                text || (
                  ...
                  >
                    <HambugerSkewed />
                    <p className='capitalize font-bold tracking-widest ml-3 text-normal text-black'>
                      All Categories
                    </p>
                    <AllCategories
