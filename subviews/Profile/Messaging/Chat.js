...
const Chat = ({ selectedContact, setSelectedContact }) => {
  ...
  return (
    ...
    >
      <header className='sticky md:fixed md:pl-6 md:pt-4 md:top-0 md:left-0 md:z-40 w-full z-10 bg-white shadow-inner md:shadow-none px-4 border-b py-2 border-gray-200'>
        {selectedContact && (
          <div
        ...
        <div className='flex items-center'>
          <span
            className={`inline-block w-2 h-2 mr-2 bg-${
      ...
      <div className='sticky md:fixed z-50 md:w-full bg-white items-center flex justify-center bottom-0 right-0'>
